...
data class FetchResponse(val people: ArrayList<Person>, val next: String?)
...
class DataSource {
    ...
    private object Constants {
        val peopleCountRange: ClosedRange<Int> = 100000..500000 // lower bound must be > 0, upper bound must be > lower bound
        val fetchCountRange: ClosedRange<Int> = 20..50 // lower bound must be > 0, upper bound must be > lower bound
